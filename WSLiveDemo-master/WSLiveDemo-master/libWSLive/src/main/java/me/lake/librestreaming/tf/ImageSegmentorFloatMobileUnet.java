...
package me.lake.librestreaming.tf;
...
public class ImageSegmentorFloatMobileUnet extends ImageSegmentor {
  ...
  protected void set_frame_props( Bitmap bg_bmp){

      /* Set size of global frames and initialize bitmaps */
      frame_hieght= bg_bmp.getHeight();
      frame_width=bg_bmp.getWidth();
