...
package com.teachk.publisherYoumu.ImageSegmentor;
...
public class ImageSegmentorFloatMobileUnet extends ImageSegmentor {
  ...
  protected void set_frame_props(){
      ...
      frame_hieght= MainLandScapeActivity.textureView.getHeight();
      frame_width=MainLandScapeActivity.textureView.getWidth();
  ...
  public Mat color_transfer(Mat src, Mat tgt) {
    ...
    if (segmap!=null){
      ...
      resbmp=MainLandScapeActivity.renderSmooth(bg_bmp,fg_bmp,tmpbmp);
